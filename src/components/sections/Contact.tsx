      ...
      <div className="container">
        ...
        >
          ...
          <ContactContent role="article">
            ...
            <ContactEmail 
              href="http://Miracleemmanuel995@gmail.com"
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              aria-label="Send me an email at Miracleemmanuel995@gmail.com"
            >
              <FaEnvelope aria-hidden="true" />
              <span>Miracleemmanuel995@gmail.com</span>
            </ContactEmail>
            <SocialLinks 
              variants={itemVariants}
              role="list"
            ...
            >
              <SocialLink 
                href="https://github.com/miracle-emmanuel"
                target="_blank"
              ...
              <SocialLink 
                href="https://x.com/king_miracle__"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ y: -5 }}
                role="listitem"
              ...
              <SocialLink 
                href="https://instagram.com/miracle_mic_"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ y: -5 }}
                role="listitem"
